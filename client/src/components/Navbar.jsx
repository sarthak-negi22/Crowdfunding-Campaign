    ...
    <div className="flex md:flex-row flex-col-reverse justify-between mb-[35px] gap-6">
      ...
      <div className="w-[40px] h-[40px] rounded-[10px]] bg-[#2c2f32] flex justify-center items-center cursor-pointer">
          ...
          <img
            src={menu}
            alt="menu"
            className="w-[32px] h-[34px] object-contain cursor-pointer "
            onClick={() => setToggleDrawer((prev) => !prev)}
          />

          <div className={`absolute top-[60px] right-0 left-0 bg-[#1c1c24] z-10 shadow-secondary py-4 ${!toggleDrawer ? '-translate-y-[100vh]' : 'translate-y-0'} transition-all duration-700ms`}>
